...
class SkillRequirementTests(unittest.TestCase):
    ...
    def test_planning_pr_creates_lightweight_pr_plan_from_issue(self) -> None:
        ...
        self.assertIn("If the next workflow skill requires a concrete implementation spec and none exists, stop and request that artifact", text)
        ...
        self.assertIn("requires a concrete implementation spec and none exists", dev_workflow)
